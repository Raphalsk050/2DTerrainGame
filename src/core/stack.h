...
struct Stack {
    ...
    Item AsItem() const { return Item{what}; }
    ...
    const char *Name() const {
        ...
        case Holds::Item: return item::Table().At(what).name;
    ...
    int Limit() const {
        ...
        case Holds::Item: return item::Table().At(what).stack;
        case Holds::Nothing: break;
        }
...
inline Stack ItemsOf(Item item, int count) {
...
inline Picture PictureOf(const Stack &stack) {
    ...
    case Holds::Item: return item::Table().At(stack.what).picture;
    case Holds::Nothing: break;
    }
