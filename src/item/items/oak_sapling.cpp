#include "item/items/oak_sapling.h"
...
// oak sapling exists — not a table, not an enum, not the build, which globs this
// directory rather than listing it.
namespace {

const registry::Registrar<ItemDef> entry{items::kOakSapling};
