...
// bat exists — not a table, not an enum, not the build, which globs this directory
// rather than listing it.
namespace {

const registry::Registrar<mob::Def> entry{mobs::kBat};
