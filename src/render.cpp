...
void render::LitWorld(const World &world, const Grove &grove, const fixture::Fixtures &fixtures, const Player &player,
...
void render::Scene(const World &world, const Grove &grove, const Inventory &inventory, const Player &player,
